...
1.   coolant, stator_winding, stator_tooth, stator_yoke, ambient & pm are tempearture related quantities with unit in celcius.
2.   u_q, u_d, i_q, i_d are voltage and current quantities.
